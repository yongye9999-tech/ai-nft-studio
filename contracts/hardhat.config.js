// hardhat.config.js — Hardhat configuration for AI+NFT Studio contracts
// Supports localhost, Sepolia, Polygon Amoy, and BNB Testnet networks.
...
module.exports = {
  ...
  // Block explorer verification config
  etherscan: {
    apiKey: {
